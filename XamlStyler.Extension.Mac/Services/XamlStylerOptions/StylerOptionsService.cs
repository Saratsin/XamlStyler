...
{
    public class StylerOptionsService : IStylerOptionsService
    {
        private const string OptionsFileName = "Settings.XamlStyler";

        private string GlobalOptionsFilePath => OptionsFileName; //UserProfile.Current.ConfigDir.Combine(OptionsFileName).FullPath;
